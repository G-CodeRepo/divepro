...
public class DiveProfileCreator {
	...
	// Constructor
	public DiveProfileCreator(int diveDepth, int bottomTime, double timeOnSurface, int nextDiveDepth) {
	...
	public static void main(String[] args) {
		...
		DiveProfileCreator dt = new DiveProfileCreator(depth, bottomTime, surfaceInterval, nextDiveDepth);
